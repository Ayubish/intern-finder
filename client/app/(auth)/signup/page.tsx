...
export default function Signup() {
    ...
    const [rad, setRad] = useState("company")
    return (
        <div className="flex flex-col gap-5 justify-center items-center py-10">
            ...
            <div className="flex gap-20 text-2xl font-semibold">
                <div className={`p-5 px-8 w-sm border rounded-2xl cursor-pointer transition-all duration-200 ${rad == 'company' ? 'bg-gray-100 border-2 border-black' : 'hover:shad'}`} onClick={() => setRad("company")}>
                ...
                <div className={`p-5 px-8 w-sm border rounded-2xl cursor-pointer ${rad == 'intern' ? 'bg-gray-100 border-2 border-black' : 'hover:bord'}`} onClick={() => setRad("intern")}>
                    <div className="flex justify-between items-center">
                        <UserSearch size={30} />
                        <Input
                            name="optio"
